...
# ==============================================================================
"""Reach-avoid curriculum level 2 (reset on success/failure)."""
...
class ReachAvoidCurriculumLevel2(ReachAvoidCurriculumLevel1):
    """An agent must reach a goal while avoiding hazards."""

    def __init__(self, config) -> None:
        super().__init__(config=config)

        self.hazards.keepout = 0.3
        self.hazards.size = 0.3
        self.hazards.num = 1
        self.agent.placements = [[-1, -1, 1, 0]]
        self.goal.placements = [[-1, 0.5, 1, 1.5]]
